...
Start by finding the relevant code. Use available file search to locate directories, files, and key symbols, then read the actual implementation. Don't guess from names. Read the code.
