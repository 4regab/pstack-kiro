...
- Skill reads or resource references against workspace `.kiro/skills/` or user-level `~/.kiro/skills/`
- Subagent delegation prompts that name a skill path
- Available file, shell, or MCP actions that match a skill's documented workflow
