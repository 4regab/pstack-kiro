...
Use the available named Kiro architect runner agents through the subagent capability. Omit per-call model settings; named custom agents may supply their own supported configuration, otherwise use Kiro's selected or default model.
