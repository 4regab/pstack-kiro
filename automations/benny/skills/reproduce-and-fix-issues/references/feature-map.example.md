...
Copy this file outside `.benny/automations/benny/`, for example to `.benny/feature-map.md`, and set `control.feature_map_path` to the copy. Pack refreshes must not overwrite it.
